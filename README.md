...
- **全息球呈现**：小脸包在深色球面上（TSL 平面投影采样，正面朝观察者；背面
  强制纯色，杜绝镜像），告别平面贴片感；黄铜赤道环 + 正交经线笼架 + 舱顶支架，
  学主项目的装配思路；
- **海洋气泡**：140 颗上升气泡环绕潜水艇（InstancedMesh 单次绘制，摆动 + 缩放
  脉动），移植自主项目深海增强版（`D:\vibe-submarine` 粒子系统）；
- **自动轮询完整保留**：
